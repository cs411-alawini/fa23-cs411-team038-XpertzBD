...
function App() {
  return (
    <Router>
      <div>
        <nav>
          <Link to="/">Home</Link> | <Link to="/report">Report Case</Link> | <Link to="/search">Search Case</Link>| <Link to="/advancedSQL1">AdvSQL1(FreqList)</Link> | <Link to="/summary1">Summary1</Link> | <Link to="/advancedSQL2">AdvSQL2(StatByHour)</Link> | <Link to="/summary2">Summary2</Link> 
        </nav>
